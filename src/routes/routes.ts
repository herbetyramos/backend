...
const uploadCurso = multer(uploadConfig.upload("uploads"));
const uploadProfessor = multer(uploadConfig.upload("./tmp/professor"));
const sendCronogramaController = new SendCronogramaController();
const deleteCronogramaController = new DeleteCronogramaController();
const relatorioDetentoraController = new RelatorioDetentoraController();
const getSaldoDetentoraController = new GetSaldoDetentoraController();
// rotas users
...
// rotas segmento
router.post('/segmento', IsAuthenticated, new CreateSegmentoController().handle);
router.get('/segmento', IsAuthenticated, new ListSegmentoController().handle);

// rotas cursos
router.post('/cursos', IsAuthenticated, uploadCurso.single('file'), new CreateCursosController().handle);
router.get('/cursos', IsAuthenticated, new ListCursosController().handle);

// professores
router.post("/professor", IsAuthenticated, uploadProfessor.single("file"),
  new CreateProfessorController().handle);

router.get("/professor", IsAuthenticated,
...
// local
router.post('/local', IsAuthenticated, new CreateLocalController().handle);
router.get('/local', IsAuthenticated, new ListLocalController().handle);

// licitação
router.post('/licitacao', IsAuthenticated, new CreateLicitacaoController().handle);
router.get('/licitacao', IsAuthenticated, new ListLicitacaoController().handle);

// ata
router.post('/ata', IsAuthenticated, new CreateAtaController().handle);
router.get('/ata', IsAuthenticated, new ListAtaController().handle);

// detentora
router.post('/detentora', IsAuthenticated, new CreateDetentoraController().handle);
router.get('/detentora', IsAuthenticated, new ListDetentoraController().handle);
router.get("/cronograma/relatorio-detentora", relatorioDetentoraController.handle);
router.get("/detentora/saldo", getSaldoDetentoraController.handle);
...
// formatura
router.post('/formatura', IsAuthenticated, new CreateFormaturaController().handle);
router.get('/formatura', IsAuthenticated, new ListFormaturaController().handle);

// bloco
router.post('/bloco', IsAuthenticated, new CreateBlocoController().handle);
router.get('/bloco', IsAuthenticated, new ListBlocoController().handle);

// cronograma
router.post('/cronograma', IsAuthenticated, new CreateCronogramaController().handle);
router.get("/listcronograma", IsAuthenticated, new ListCronogramaController().handle);
router.post("/sendemailcronograma", uploadCurso.single("file"), 
(req, res) => sendCronogramaController.handle(req, res)
);
router.get("/ofertacursos", new ListOfertaCursoController().handle);

router.delete("/listcronograma/:id", new DeleteCronogramaController().handle);
router.get("/cronograma/:id",new GetCronogramaController().handle);
router.put("/cronograma/:id",  new UpdateCronogramaController().handle);

// ALUNO
router.post("/aluno", new CreateAlunoController().handle);
router.get("/aluno", new ListAlunoController().handle);
router.put("/aluno", new UpdateAlunoController().handle);
router.delete("/aluno/:id", new DeleteAlunoController().handle);

// MATRICULA
router.post("/matricula", new CreateMatriculaController().handle);
router.get("/matricula", new ListMatriculaController().handle);
router.put("/matricula/:id", new UpdateMatriculaController().handle);
router.delete("/matricula/:id", new DeleteMatriculaController().handle);

// MATERIAIS
router.post("/material", new CreateMaterialController().handle);
router.get("/material", new ListMaterialController().handle);
router.put("/material", new UpdateMaterialController().handle);
router.delete("/material/:id", new DeleteMaterialController().handle);
